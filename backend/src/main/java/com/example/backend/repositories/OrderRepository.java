...
public interface OrderRepository extends JpaRepository<Order, Long> {
        ...
        @Query("SELECT SUM(o.amount) FROM Order o WHERE o.createdBy.id = :userId AND o.createdAt >= :startOfDay AND o.createdAt < :endOfDay")
        BigDecimal getTotalAmountForTodayByUser(@Param("userId") Long userId,
        ...
        @Query("SELECT FORMAT(o.createdAt, 'yyyy-MM') AS month, " +
                        ...
                        "GROUP BY FORMAT(o.createdAt, 'yyyy-MM') " +
                        "ORDER BY month DESC")
        List<Object[]> getAmountByMonthForUser(@Param("userId") Long userId);
        ...
        @Query("SELECT COUNT(o) FROM Order o WHERE o.createdBy.id = :userId AND o.createdAt >= :startOfDay AND o.createdAt < :endOfDay")
        Integer countOrdersForTodayByUser(@Param("userId") Long userId,
                        @Param("startOfDay") LocalDateTime startOfDay,
                        @Param("endOfDay") LocalDateTime endOfDay);
